[[Build status][https://github.com/bendudson/py4cl/workflows/Tests/badge.svg]]
...
Tests use [[https://github.com/tgutu/clunit][clunit]], and run on Github actions. Most development
